...
*share_simSRE = 1 assigns the entire effect to hours with PV generation (simultaneous profile)
*share_sweSRE = 0 means no additional demand is allocated to PV-free (off-peak) hours
share_simSRE /1/
share_sweSRE /0/
;
