...
absolute_data = {
    'full_avail_ref': [
        [231, 1245, 793, 524, 1, 8, 41, 503, 33, 1347, 62],
        [226, 1456, 975, 925, 9, 22, 47, 501, 38, 1110, 59],
        [247, 1662, 1229, 1334, 42, 59, 64, 499, 48, 879, 7],
        [349, 1936, 1535, 1536, 62, 103, 140, 498, 66, 628, 4],
        [341, 2102, 1782, 1726, 51, 158, 163, 496, 69, 426, 2]
    ],
    'avg_avail': [
        [191, 1221, 811, 524, 1, 8, 41, 502, 37, 1352, 62],
        [213, 1449, 977, 925, 9, 22, 47, 501, 39, 1111, 59],
        [241, 1663, 1230, 1334, 42, 57, 64, 499, 47, 881, 7],
        [351, 1941, 1526, 1536, 62, 103, 140, 498, 65, 628, 4],
        [336, 2107, 1780, 1726, 51, 156, 163, 496, 68, 427, 2]
    ],
    'low_avail': [
        [75, 1063, 841, 524, 1, 12, 44, 502, 50, 1360, 61],
        [133, 1338, 1021, 924, 11, 20, 49, 501, 48, 1120, 59],
        [184, 1589, 1286, 1341, 44, 57, 64, 498, 55, 887, 7],
        [215, 1856, 1620, 1537, 63, 155, 153, 497, 75, 626, 4],
        [200, 2018, 1864, 1731, 52, 230, 176, 495, 80, 425, 2]
    ]
}
    ...
    for idx, year in enumerate(years):
        ...
        for neg_idx, neg_tech in enumerate(neg_tech_labels):
            ...
            if abs(value) < 0:
                ...
                if not (neg_tech == 'Battery charging' and year == 2030):
